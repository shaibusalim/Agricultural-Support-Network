...
<div class="profile-container">
        ...
        <div class="profile-info">
                    ...
                    if (isset($_SESSION['owner_id'])) {
                        ...
                        $query = "SELECT * FROM tractor_owners WHERE owner_id=?";
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            echo "<p><span>Phone Number:</span> " . $row['phone'] . "</p>";
                            echo "<p><span>Number of Tractors:</span> " . $row['No'] . "</p>";
                            echo "<p><span>Type of Tractor:</span> " . $row['type'] . "</p>";
...
<p>Please click <a href="tractor-owner-dash.php">here<a/> to go back to your Dashboard</p>
</body>
</html>

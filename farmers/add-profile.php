 ...
 session_start();
            ...
            include "../connection.php"; 
                ...
                if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_SESSION['farmer_id'])){
                        ...
                        $sql = "UPDATE farmers SET firstName=?, lastName=?, address=?, location=?, crop=? WHERE farmer_id =?";

                        $stmt = $conn->prepare($sql);
                        $stmt->bind_param("sssssi", $firstName, $lastName, $address, $location, $crop, $farmerId);
    ...
    p{
        ...
        <form action='add-profile.php' method='POST'>
            ...
            <input type='text' name='crop' placeholder='Enter Crop Type'><br>

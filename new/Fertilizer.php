...
<div class="header">
	 ...
	 <br>
	  <div class="header-right">
	   <a style="font-size: 25px;" href="tech.php">Tech</a>
	   <a style="font-size: 25px;" href="solarpanel.php">Solar Panel</a>
	   </div>
</div>
	 ...
	 <div class="blog_1 clearfix">
	  <div class="col-sm-4 clearfix">
	   <div class="blog_home1i clearfix">
		...
		<div class="blog_home1il clearfix">
          <h6 class="mgt"><span class="date">December</span> <span class="year">2023</span></h6>	
		</div>
	  </div>
	  </div>
	  <div class="col-sm-8 clearfix">
  ...
  <div class="row">
   <div class="col-sm-12">
    <div class="footer_main_1">
	 <h2>Developed By Team Gh0sT-Tech</h2>
	</div>
   </div>
  </div>
 </div>
...
<section id="footer">
 <div class="container">
  <div class="row">
   ...
   <div class="col-sm-12">
    <div class="footer_5">
	 <p> © 2021 ASN-ALL YOU NEED FOR AGRONOMY . All Rights Reserved | Design by Team Gh0sT-Tech</p>
	</div>   
   </div>
  </div>
 </div>

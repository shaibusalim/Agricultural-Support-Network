    ...
    <div class="header">
     ...
     <br>
      <div class="header-right">
       ...
       <a style="font-size: larger;" href="Fertilizer.php">Fertilizer</a>
       </div>
...
<table>
	<tr>
		<td>
			<h2>Solar Panesl in Ghana</h2>
 				<hr />
         Ghana, like many other countries, is endowed with significant solar energy potential due to its location near the equator, receiving ample sunlight throughout the year.
         Ghana receives an average daily solar irradiance ranging from about 4 to 6 kWh per square meter, which is comparable to the levels experienced in regions where solar power has been extensively harnessed for energy generation.
         Utilizing solar photovoltaic (PV) technology, Ghana can effectively harness this abundant solar resource to generate electricity. The scalability of solar power offers immense potential for the country, allowing for rapid capacity addition with relatively short lead times.
         Moreover, the decentralized nature of solar power generation allows for off-grid applications, particularly advantageous for rural electrification initiatives. It can address energy needs in both rural and urban areas, offering a sustainable solution for power, heating, and cooling requirements.
         Solar energy also contributes significantly to energy security, as it is a renewable resource abundantly available in Ghana. From an energy security perspective, solar power stands out as one of the most secure sources.
         Theoretically, even a fraction of the total incident solar energy, if effectively captured and utilized, could potentially meet a substantial portion of Ghana's power requirements, contributing to the country's energy independence and sustainability goals.
 						<br />
			...
			<h2>Policies and Schemes regarding Solar Panels</h2></i>
 				<p>
          Ghana has been actively working on policies and initiatives to promote the adoption of solar energy within the country.Ghana government established the Renewable Energy Master Plan, outlining strategies and targets for the development of renewable energy sources, including solar energy. This plan sets specific goals for solar energy capacity and implementation over the coming years.
 				</p>
			<h3>You can find  more information here:-</h3>

				<ul>
  					<li>
    					<a href="https://www.sciencedirect.com/science/article/pii/S2468227622000710">Solar energy policy implementation in Ghana</a>
  					</li>
  					<br />
  					<li>
  					<a href="http://www.smartsolar-ghana.com/solar-sector-information/subsidies-for-solar-in-ghana/">Subsidies for Solar in Ghana</a>
  					</li>
  					<br />
  					<li>
   					<a href="https://www.esi-africa.com/renewable-energy/solar/ghana-solar-powered-project-to-boost-vegetable-farmers-output/">Ghana: Solar-powered project to boost vegetable farmers' output</a>
  					</li>
  					<br />
				</ul>
		</td>
...
<div class="col-container">
  <div class="col" style="border-style: solid;">
    <h3>How Solar Energy Can Coincide With Crop and Animal Agriculture?</h3>
		Solar panels, while taking up space, can actually be installed in a manner that benefits agricultural activities. Research has shown that crops can thrive and animals can graze beneath elevated solar panels. This dual land use strategy allows for both solar energy generation and agricultural production on the same land.
    This approach, known as agrivoltaics, offers several advantages. Firstly, it maximizes land productivity by effectively utilizing space for both solar energy generation and agricultural activities. Farmers can continue their traditional farming practices while also generating clean energy.
  </div>
...
The National Renewable Energy Laboratory has continued to fund other research efforts in states across the country.
 ...
 <br />
<p>
  <img src="../nimages/lighting-global-solar-woman-agriculture-.jpg" alt="Solar Panel" style="height: 400px">

  <img src="../nimages/solar.jpg" alt="Solar Panel" style="height: 400px; float:right;">
</P>

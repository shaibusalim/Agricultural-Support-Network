...
// Display notifications for tractor owner or mover
...
$notificationsQuery = "SELECT ton.notification_id, ton.notification_text, ton.booking_id, ton.booking_date, ton.booking_time, ton.additional_requests, ton.is_confirmed
                       FROM tractor_owners_notifications ton
                       WHERE ton.owner_id = ? AND ton.is_confirmed = 0";
...
if (isset($_POST['confirm_booking'])) {
    ...
    $updateQuery = "UPDATE tractor_owners_notifications SET is_confirmed = 'Confirmed by' WHERE notification_id = ?";
    ...
    $updateBookingQuery = "UPDATE bookings SET status = 'Confirmed' WHERE notification_id = ?";

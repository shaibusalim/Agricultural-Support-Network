...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO farmers (firstName, lastName, address, phone, location, crop, email) VALUES (?, ?, ?, ?, ?, ?, ?)";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("sssssss", $firstName, $lastName, $address, $phone, $location, $crop, $email);
        ...
        <div class="pcoded-container navbar-wrapper">
         ...
         <div class="pcoded-main-container">
             ...
             <div class="pcoded-content mainContent">
                 ...
                 <form id="addFarmerForm" method="post" action="add_farmer.php">
                
                        <input type="text" name="firstName" placeholder="First Name"><br>
                        <input type="text" name="lastName" placeholder="Last Name"><br>
                        <input type="text" name="address" placeholder="Address"><br>
                        <input type="text" name="crop" placeholder="crop type"><br>
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<td>
        <a href='edit_farmer.php?farmer_id=".$row['farmer_id']."' class='btn btn-primary btn-sm'>Edit</a>
        <button onclick='deleteFarmer(".$row['farmer_id'].")' class='btn btn-danger btn-sm'>Delete</button>
      </td>";
...
function deleteFarmer(farmer_id) {
    if (confirm("Are you sure you want to delete this farmer?")) {
        ...
        xhr.open("GET", "delete_farmer.php?farmer_id=" + farmer_id, true);
        xhr.send();
    }
}

             ...
             <div class="pcoded-content mainContent">
                    <div class="pcoded-inner-content">
                        <div class="main-body">
                            ...
                            <form id="addFarmerForm" method="post" action="add_mover.php">
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        <button onclick='deleteMover(".$row['mover_id'].")' class='btn btn-danger btn-sm'>Delete</button>
      </td>";
...
function deleteMover(mover_id) {
    if (confirm("Are you sure you want to delete this mover?")) {
        ...
        xhr.open("GET", "delete_mover.php?mover_id=" + mover_id, true);
        xhr.send();
    }
}

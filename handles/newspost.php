...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (move_uploaded_file($_FILES["image"]["tmp_name"], $target_file)) {
        ...
        $sql = "INSERT INTO news_articles (alt_text, title, posted_date, content, image, article_link)
                VALUES (?, ?, ?, ?, ?, ?)";
        ...
        $stmt->bind_param("ssssss", $altText, $title, $posted_on, $content, $imageURL, $link);
...
<div id="pcoded" class="pcoded">
        ...
        <label for="alt_text">Image Alt Text:</label><br>
        <input type="text" id="alt_text" name="alt_text" required><br>
        ...
        <input type="text" id="article_link" name="article_link" required><br>
...
function deleteNews(id) {
    if (confirm("Are you sure you want to delete this News Articles?")) {
        ...
        xhr.open("GET", "delete_news.php?id=" + id, true);
        xhr.send();
    }
}

...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (move_uploaded_file($_FILES["farm_image"]["tmp_name"], $target_file)) {
        ...
        $sql = "INSERT INTO farms (farm_name, location, farm_size, crops_grown, livestock, image_url)
                VALUES ('$farmName', '$location', '$farmSize', '$cropsGrown', '$livestock', '$imageURL')";
...
function deleteFarm(id) {
    if (confirm("Are you sure you want to delete this farm?")) {
        ...
        xhr.open("GET", "delete_farm.php?id=" + id, true);
        xhr.send();
    }
}
